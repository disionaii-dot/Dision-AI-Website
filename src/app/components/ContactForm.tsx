...
const supabaseUrl = 'https://qsewqxfslndtpxtysbor.supabase.co';
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFzZXdxeGZzbG5kdHB4dHlzYm9yIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzQ2OTIxNjQsImV4cCI6MjA5MDI2ODE2NH0.jjSJlRvgy1-29-UXQJZQ4tJpOvnndbglDdvZgGA3nSo';
...
export function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Logic for successful submission UI
      setIsSubmitted(true);
        ...
        <div className="relative group">
          ...
          <div className="relative p-8 md:p-12 bg-[#1F2937]/50 backdrop-blur-sm border border-blue-500/30 rounded-3xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-[#111827] border border-gray-700 rounded-lg text-white focus:outline-none focus:border-blue-500 transition-all"
              ...
              <div>
                <label htmlFor="businessDescription" className="block text-sm font-medium text-gray-300 mb-2">What does your business do? *</label>
                <textarea
                  ...
                  onChange={handleChange}
                  rows={3}
                  className="w-full px-4 py-3 bg-[#111827] border border-gray-700 rounded-lg text-white focus:outline-none focus:border-blue-500 transition-all resize-none"
                  placeholder="Briefly describe your business..."
                />
              </div>

              <div>
                <label htmlFor="helpNeeded" className="block text-sm font-medium text-gray-300 mb-2">What do you need help with? *</label>
                <textarea
                  id="helpNeeded"
                  name="helpNeeded"
                  required
              ...
              <div>
                <label htmlFor="biggestProblem" className="block text-sm font-medium text-gray-300 mb-2">What is your biggest problem right now? *</label>
                <textarea
                  id="biggestProblem"
                  name="biggestProblem"
                  required
              ...
              <div>
                <label htmlFor="demoCall" className="block text-sm font-medium text-gray-300 mb-2">Do you want a free demo call? *</label>
                <select
                  id="demoCall"
                  name="demoCall"
                  required
